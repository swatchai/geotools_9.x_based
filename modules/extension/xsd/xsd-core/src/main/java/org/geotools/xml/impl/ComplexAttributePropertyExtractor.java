 ...
 * @source $URL$
 */
public class ComplexAttributePropertyExtractor extends BindingPropertyExtractor {

    public ComplexAttributePropertyExtractor(Encoder encoder, MutablePicoContainer context) {
    	super(encoder, context);
    }
...
O: 
        ...
        */
        if (properties.size() > 1 && propertiesSortable(properties, children)) {
